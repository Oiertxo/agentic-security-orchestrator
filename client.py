...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Agentic Security Orchestrator CLI Client")
    
    parser.add_argument("query", type=str, help="The security task or question")
    parser.add_argument("--thread", "-t", type=str, default="default_thread", help="Thread ID for persistence")
    parser.add_argument("--fresh", "-f", action="store_true", help="Start a new audit (wipes old thread data)")
